...
// الشيف يضع الطلب "ready" ثم "delivering" ← نقطة الالتقاء
const DELIVERY_STATUSES = ["ready", "delivering", "delivered"];
...
// نستمع للطلبات ذات الحالات: ready, delivering, delivered
// ملاحظة: لا نستخدم orderBy مع where لتجنب الحاجة لـ Composite Index
// الترتيب يتم محلياً بعد الجلب
